...
由于 wsl2 内 Ubuntu 22.04 官方软件源的 OpenGL 版本较低，无法正常运行 gazebo ，所以添加第三方 mesa 源。
...
PX4-Autopilot 项目里有写好的有 ros1 的 launch 文件，可以直接启动，但是可以没有提供 ros2 版的，所以我们可以写一个简单的 PX4 启动脚本。
